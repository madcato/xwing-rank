...
class RankingsControllerTest < ActionController::TestCase
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post :create, ranking: { breakpoints: @ranking.breakpoints, player_id: @ranking.player_id, points: @ranking.points, sos: @ranking.sos }
    end
  ...
  test "should update ranking" do
    patch :update, id: @ranking, ranking: { breakpoints: @ranking.breakpoints, player_id: @ranking.player_id, points: @ranking.points, sos: @ranking.sos }
    assert_redirected_to ranking_path(assigns(:ranking))
  end
